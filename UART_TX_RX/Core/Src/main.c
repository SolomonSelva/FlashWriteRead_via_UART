...
/* MCU Used : STM32 F767ZI */

#define FLASH_USER_START_ADDR   ADDR_FLASH_SECTOR_2   /* Start @ of user Flash area */

#define BUFFER_SIZE            1012         // Adjust size as needed, for the given string the buffer is 1012.
